// File IO for the Copilot hooks logger. All paths resolve under
// <workspace>/.copilot/run-logs/<sessionId>/ (workspace = hook cwd,
...
export const RUN_LOGS_DIR = join(".copilot", "run-logs");
...
// Back-compat alias (cline fork named this serializeLiveTurn).
